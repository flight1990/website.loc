            ...
            <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden">
                ...
                <form>
                    <div class="p-4 sm:p-10 overflow-y-auto">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-rose-500 mt-2">{{ form.errors.title }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-rose-500 mt-2">{{ form.errors.content }}</p>
                            </div>

                            <div>
                                <label for="client" class="block text-sm font-medium mb-2">Ваше имя</label>
                                <input type="text" id="client" v-model="form.client" class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-primary-500 focus:ring-primary-500">
                                <p class="text-sm text-rose-500 mt-2">{{ form.errors.client }}</p>
                            </div>
                    ...
                    <div class="flex justify-end items-center gap-x-2 py-3 px-4 bg-gray-50 border-t">
                        <button type="button"
                                class="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-primary-600 transition-all text-sm"
                                data-hs-overlay="#review-modal">
                            Отмена
                        </button>
                        <button :disabled="form.processing" @click.prevent="create"
                                class="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-primary-500 text-white hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all text-sm">
                            Отправить отзыв
                        </button>
                    </div>
                </form>
